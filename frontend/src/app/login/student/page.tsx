...
export default function StudentLogin() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Optional structural check. If a teacher logs in here, redirect them or show error.
            if (data.role !== 'student') {
                throw new Error("This login page is for Students only. Please use the Teacher Login.");
            }
                ...
                <FadeIn direction="up">
                    <div className="premium-card p-10">
                        <div className="text-center mb-10">
                            ...
                            <h2 className="text-3xl font-black text-corporate-950 mb-2 tracking-tighter">Student Access</h2>
                            <p className="text-corporate-400 font-medium">Coordinate your academic progress.</p>
                        </div>
                        ...
                        <div className="mt-10 pt-8 border-t border-corporate-50 text-center">
                            <p className="text-sm text-corporate-400 font-medium">
                                Not a student?{" "}
                                <Link href="/login/teacher" className="font-black text-primary-700 hover:text-primary-800 transition-colors">
                                    Switch to Faculty
                                </Link>
                            </p>
                        </div>

...
import { ShieldCheck, ArrowLeft, Lock, User } from "lucide-react";
                ...
                <FadeIn direction="up">
                    <div className="premium-card p-10">
                        <div className="text-center mb-10">
                            ...
                            <h2 className="text-3xl font-black text-corporate-950 mb-2 tracking-tighter">Command Access</h2>
                            <p className="text-corporate-400 font-medium">Restricted gateway for suite orchestration.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                <label className="block text-[10px] font-black uppercase tracking-widest text-corporate-400 mb-2 px-1">Admin Identity</label>
                            ...
                            <div>
                                <label className="block text-[10px] font-black uppercase tracking-widest text-corporate-400 mb-2 px-1">Secret Key</label>
                                <div className="relative">
                                    <input
                                        type="password"
                                        required
                            ...
                            <Magnetic>
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full mt-4 bg-corporate-950 hover:bg-black text-white font-black py-4 px-4 rounded-2.5xl transition-all shadow-premium disabled:opacity-50 text-sm uppercase tracking-widest"
                                >
                                    {isLoading ? "Authenticating..." : "Authorize Administrative Entry"}
                                </button>
                            </Magnetic>
                        </form>
